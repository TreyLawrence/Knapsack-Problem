...
Rules, if successfully implemented will return 'OK', otherwise the text "I have no idea what you are talking about" will be returned.

Questions, if answerable will return the answer, otherwise the text "I have no idea what you are talking about" will be returned.

To exit the program, type in 'exit' to the prompt.